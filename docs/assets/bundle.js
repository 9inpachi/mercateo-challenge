...
var todoLabel_1 = require("./todoLabel");
var constants_1 = require("./constants");
var TodoApp = (function (_super) {
    __extends(TodoApp, _super);
    function TodoApp(props) {
        var _this = _super.call(this, props) || this;
        _this.newField = React.createRef();
        _this.labelField = React.createRef();
        _this.state = {
    ...
    TodoApp.prototype.addTodoItem = function () {
        var val = ReactDOM.findDOMNode(this.newField.current).value.trim();
        if (val) {
    ...
    TodoApp.prototype.addLabel = function (e) {
        if (e.keyCode !== constants_1.ENTER_KEY) {
            return;
        }
        var newLabelField = ReactDOM.findDOMNode(this.labelField.current);
        var val = newLabelField.value;
        if (val && !this.state.newTodoLabels.includes(val)) {
            this.setState({ newTodoLabels: this.state.newTodoLabels.concat([val]) });
            newLabelField.value = '';
        }
    };
    TodoApp.prototype.deleteLabel = function (value) {
        if (value) {
            var todoLabels = this.state.newTodoLabels;
    ...
    TodoApp.prototype.render = function () {
        ...
        var todoItems = shownTodos.map(function (todo) {
            return (React.createElement(todoItem_1.TodoItem, { key: todo.id, todo: todo, onToggle: _this.toggle.bind(_this, todo), onDestroy: _this.destroy.bind(_this, todo), onEdit: _this.edit.bind(_this, todo), editing: _this.state.editing === todo.id, onSave: _this.save.bind(_this, todo), onCancel: function (e) { return _this.cancel(); }, onLabelReplace: function (value, newValue) {
                    _this.props.model.replaceLabel(todo, value, newValue);
                }, onLabelRemove: function (value) { return _this.props.model.removeLabel(todo, value); }, onLabelAdd: function (value) { return _this.props.model.addLabel(todo, value); } }));
        });
        ...
        return (React.createElement("div", null,
            React.createElement("header", { className: "header" },
                ...
                React.createElement("div", { className: "new-todo-wrapper" },
                    React.createElement("input", { ref: this.newField, className: "new-todo", placeholder: "What needs to be done?", onKeyDown: function (e) { return _this.handleNewTodoKeyDown(e); }, autoFocus: true }),
                    React.createElement("button", { className: "add-todo", onClick: this.addTodoItem.bind(this) }),
                ...
                React.createElement("div", { className: "labels" },
                    React.createElement("input", { ref: this.labelField, className: "label-input", placeholder: "Add label", onKeyDown: this.addLabel.bind(this), autoFocus: true }),
                    React.createElement("div", { className: "labels-added" }, this.state.newTodoLabels && this.state.newTodoLabels.length > 0 &&
                        this.state.newTodoLabels.map(function (label, i) {
                            return React.createElement(todoLabel_1.default, { key: _this.props.model.key + '-todo-label-' + i, editable: false, deletable: true, label: label, onRemove: _this.deleteLabel.bind(_this) });
                        })))),
            main,
            footer));
    };
...
},{"./constants":2,"./footer":3,"./todoItem":4,"./todoLabel":5,"./todoModel":6,"react":18,"react-dom":15}],2:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var ALL_TODOS = 'all';
...
},{"./constants":2,"./utils":7,"classnames":8,"react":18}],4:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var TodoItem = (function (_super) {
    ...
    function TodoItem(props) {
        var _this = _super.call(this, props) || this;
        _this.editField = React.createRef();
    ...
    TodoItem.prototype.render = function () {
        ...
        return (React.createElement("li", { className: classNames({
            ...
            React.createElement("div", { className: "view" },
                ...
                React.createElement("div", { className: "todo-item-labels" }, this.props.todo.labels && this.props.todo.labels.length > 0 &&
                    this.props.todo.labels.map(function (label, i) {
                        return React.createElement(todoLabel_1.default, { key: _this.props.todo.id + '-label-' + i, label: label });
                    })),
                React.createElement("div", { className: "actions" },
                    React.createElement("button", { className: "action-item edit-icon", onClick: function (e) { return _this.handleEdit(); } }),
                    React.createElement("button", { className: "action-item remove-icon", onClick: this.props.onDestroy }))),
            React.createElement("div", { className: "edit-mode" },
                React.createElement("input", { ref: this.editField, className: "edit", value: this.state.editText, onChange: function (e) { return _this.handleChange(e); }, onKeyDown: function (e) { return _this.handleKeyDown(e); } }),
                React.createElement("button", { className: "tick-icon", onClick: this.handleSubmit.bind(this) }),
                React.createElement("div", { className: "todo-item-labels todo-item-labels-edit" },
...
},{"./constants":2,"./todoLabel":5,"classnames":8,"react":18,"react-dom":15}],5:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var classNames = require("classnames");
var constants_1 = require("./constants");
var TodoLabel = (function (_super) {
    __extends(TodoLabel, _super);
    function TodoLabel(props) {
        var _this = _super.call(this, props) || this;
        _this.state = {
            editText: _this.props.label,
            editing: false
        };
        return _this;
    }
    TodoLabel.prototype.handleChange = function (e) {
        this.setState({ editText: e.target.value });
    };
    TodoLabel.prototype.handleSubmit = function (e) {
        if (this.state.editText && this.props.onReplace) {
            this.props.onReplace(this.state.editText);
        }
        this.setState({ editing: false });
    };
    TodoLabel.prototype.handleKeyDown = function (e) {
        if (![constants_1.ENTER_KEY, constants_1.ESCAPE_KEY].includes(e.keyCode)) {
            return;
        }
        else {
            if (this.state.editText && this.props.onReplace) {
    ...
    TodoLabel.prototype.render = function () {
        ...
        return (React.createElement("div", { className: classNames({
            ...
            React.createElement("div", { className: "todo-label-actions" },
                this.props.editable &&
                    React.createElement("button", { className: "todo-label-action edit-icon", onClick: function () { return _this.setState({ editing: true }); } }),
                this.props.deletable &&
                    React.createElement("button", { className: "todo-label-action remove-icon", onClick: function (e) { return _this.props.onRemove(_this.props.label); } }))));
    };
    return TodoLabel;
}(React.Component));
exports.default = TodoLabel;

},{"./constants":2,"classnames":8,"react":18}],6:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var utils_1 = require("./utils");
var TodoModel = (function () {
    ...
    TodoModel.prototype.changeLabel = function (todoToChange, label, onTodoFound) {
        this.todos = this.todos.map(function (todo) {
            if (todo !== todoToChange) {
                return todo;
            }
            else {
                var updatedTodo = onTodoFound(todo);
                return utils_1.Utils.extend({}, todo, { labels: updatedTodo.labels });
            }
        });
        this.inform();
    };
    TodoModel.prototype.replaceLabel = function (todoToChange, oldLabel, newLabel) {
        this.changeLabel(todoToChange, oldLabel, function (todo) {
            if (!todo.labels.includes(newLabel)) {
                var oldLabelIndex = todo.labels.indexOf(oldLabel);
                if (oldLabelIndex !== -1) {
    ...
    TodoModel.prototype.removeLabel = function (todoToChange, label) {
        this.changeLabel(todoToChange, label, function (todo) {
            todo.labels.splice(todo.labels.indexOf(label), 1);
            return todo;
        });
    };
    TodoModel.prototype.addLabel = function (todoToChange, label) {
        this.todos = this.todos.map(function (todo) {
            if (todo !== todoToChange) {
                return todo;
            }
                ...
                return utils_1.Utils.extend({}, todo, { labels: todo.labels });
            }
        });
        this.inform();
    };
...
},{"./cjs/scheduler-tracing.development.js":19,"./cjs/scheduler-tracing.production.min.js":20,"_process":10}]},{},[1]);
